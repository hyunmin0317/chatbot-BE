...
def search_answer(request):
    threshold = 0.5
    uid, question, clean = request.data['uid'], request.data['question'], request.data['clean']
    ...
    Result.objects.create(uid=uid, question=clean, answer=answer, pred=pred, result=result)
